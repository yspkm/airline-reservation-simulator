...
bool RB_INSERT(rbtree_t *T, key_t k) { return rb_insert_key(T, k, DUMMY_DATA); }

bool RB_DELETE(rbtree_t *T, key_t k) { return rb_delete_key(T, k); }

void PRINT_BST(rbtree_t *T) { rb_print(T, T->root, NULL, false); }
